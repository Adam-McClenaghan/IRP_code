...
customEvent = None
Last_mod = os.path.getmtime('/Users/Adam/Documents/MENG_yr3/IRP_papers/pytest.CSV')
...
class MyThread(threading.Thread):
    ...
    def run(self):
        ...
        while not self.stopped.wait(2):
            if os.path.getmtime('/Users/Adam/Documents/MENG_yr3/IRP_papers/pytest.CSV') > Last_mod:
